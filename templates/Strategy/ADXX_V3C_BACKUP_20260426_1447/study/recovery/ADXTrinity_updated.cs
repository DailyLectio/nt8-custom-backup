...
namespace NinjaTrader.NinjaScript.Strategies
{
    ...
    public class ADX_Trinity : Strategy
    {
        ...
        private bool IsBotAllowedByTrinity()
        {
            ...
            if (NinjaTrader.NinjaScript.Indicators.RegimeMatrixHUD.Instance == null)
            {
                Print("TRINITY WARNING: The RegimeMatrixHUD is not on the chart! Allowing trade.");
                return true; 
            }

            return NinjaTrader.NinjaScript.Indicators.RegimeMatrixHUD.Instance.IsAdxAllowed; 
        }
        // =========================================================================
