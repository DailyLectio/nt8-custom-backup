...
{
    // Strategy: ADX DI Cross Strategy with Pine-style Trailing Stops and VWAP filters OG
    public class Pine_Trinity : Strategy
    {
        // ===== 1. Enums =====
        ...
        private bool IsBotAllowedByTrinity()
        {
            ...
            return NinjaTrader.NinjaScript.Indicators.RegimeMatrixHUD.Instance.IsPineAllowed; 
        }
        // =========================================================================
