...
#pragma warning disable CS0162
    ...
    public static class V3DStrategyIdentity
    {
            ...
            new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "SimV3D-NQ-1B", "Expansion_V3D" },
            { "SimV3D-NQ-1C", "Expansion_V3D" },
            { "SimV3D-NQ-2A", "Momentum_V3D" },
            { "SimV3D-NQ-2B", "Momentum_V3D" },
            { "SimV3D-NQ-2C", "Momentum_V3D" },
            { "SimV3D-NQ-3A", "Fader_V3D" },
            { "SimV3D-NQ-3B", "Fader_V3D" },
            { "SimV3D-NQ-3C", "Fader_V3D" },
            { "SimV3D-NQ-4A", "Sniper_V3D" },
            { "SimV3D-NQ-4B", "Sniper_V3D" },
            { "SimV3D-NQ-4C", "Sniper_V3D" },
            { "SimV3D-NQ-5A", "ADX_DI_V3D" },
            { "SimV3D-NQ-5B", "ADX_DI_V3D" },
            { "SimV3D-NQ-5C", "ADX_DI_V3D" },
            { "SimV3D-ES-1A", "Expansion_V3D" },
            { "SimV3D-ES-1B", "Expansion_V3D" },
            { "SimV3D-ES-1C", "Expansion_V3D" },
            { "SimV3D-ES-2A", "Momentum_V3D" },
            { "SimV3D-ES-2B", "Momentum_V3D" },
            { "SimV3D-ES-2C", "Momentum_V3D" },
            { "SimV3D-ES-3A", "Fader_V3D" },
            { "SimV3D-ES-3B", "Fader_V3D" },
            { "SimV3D-ES-3C", "Fader_V3D" },
            { "SimV3D-ES-4A", "Sniper_V3D" },
            { "SimV3D-ES-4B", "Sniper_V3D" },
            { "SimV3D-ES-4C", "Sniper_V3D" },
