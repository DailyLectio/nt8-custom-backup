...
{
    public class MomentumSlopeStrategy_V2_StopModes : Strategy
    {
        ...
        private void PrintDebugEntryBlock(string side, string reason)
        {
            ...
            Print($"{Time[0]} MomentumSlopeOG_V2_StopModes debug | account={accountName} symbol={Instrument.FullName} hudSymbol={baseSymbol} side={side} EnableTrinityFilter={EnableTrinityFilter} lane=AllowMomo:{lane} finalRegime={regime} reasonCode={reasonCode} stale={stale} decision=BLOCK reason={reason}");
        }
        ...
        protected override void OnStateChange()
        {
            ...
            {
                Name = "MomentumSlopeStrategy_V2_StopModes";
