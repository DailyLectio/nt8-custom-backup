// CC BY-NC 4.0
// ADX_DI_V3D_B.cs  — V3D Institutional Regime Matrix  — Version C
// ─────────────────────────────────────────────────────────────────
...
{
    public class ADX_DI_V3D_B : Strategy
    {
        // =====================================================================
        // PARAMETERS
        // =====================================================================
        ...
        public string AccountNameFilter { get; set; } = "SimV3D-NQ-5B;SimV3D-ES-5B";
        ...
        public string ConfiguredStrategyName { get; set; } = "ADX_DI_V3D_B";
        ...
        protected override void OnStateChange()
        {
            ...
            else if (State == State.DataLoaded)
            {
                ...
                SetupFileWatcher();
                v3dTradeLogger = new V3DStrategyTradeLogger(this, AccountNameFilter, ConfiguredStrategyName, "V3D", TradeLogFolder, "V3D_ADX_DI_B", "B");
