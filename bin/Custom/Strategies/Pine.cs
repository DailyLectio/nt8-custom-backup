...
namespace NinjaTrader.NinjaScript.Strategies
{
    ...
    public class Pine : Strategy 
    {
        ...
        private bool IsBotAllowedByTrinity()
        {
            ...
            NinjaTrader.NinjaScript.Indicators.RegimeMatrixHUD hudInstance = null;
            
            if (NinjaTrader.NinjaScript.Indicators.RegimeMatrixHUD.Instances.TryGetValue(sym, out hudInstance))
            {
                if (hudInstance != null)
                {
        ...
        private const string Stage1BotName = "OG_Pine";
...
#pragma warning disable CS0162
        ...
        protected override void OnBarUpdate()
        {
            ...
            // =========================================================================
            // V3 GATEKEEPER & DIRECTIONAL ALIGNMENT (PINE MEAN REVERTER)
            // =========================================================================
            ...
            if (EnableTrinityFilter)
            {
                ...
                // Pine needs structure. Block Illiquid chop and Transition gaps.
                ...
                // 2. DIRECTIONAL PERMISSIONS: (Strict Counter-Alignment)
                // If Macro or HMM is UP, we ONLY look for exhaustion Shorts. Ban Longs.
                if (macroRegime.Contains("UP") || hmmRegime == "TrendUp")
                {
                    allowLongHud = false;
                }
                // If Macro or HMM is DOWN, we ONLY look for exhaustion Longs. Ban Shorts.
            ...
            if (Position.MarketPosition == MarketPosition.Flat)
            {
                ...
                if (canLong)
                {
                    ...
                    CaptureInitialStopTicksForLog(stopTicks, "LONG");
                    EnterLong(Contracts, "Long");
                }
                else if (canShort)
                {
                    pendingShortStopTicks = stopTicks;
                    CaptureInitialStopTicksForLog(stopTicks, "SHORT");
