...
namespace NinjaTrader.NinjaScript.Strategies
{
    public class KalmanPulse_Fader_V2 : Strategy
    {
        ...
        // Use NinjaTrader's built-in ATR so Kalman bands, stops, sizing, and
        // noise scaling use the same indicator source as the chart.
        private double ComputeAtr()
        {
            ...
            double atrVal = atr[0];
            return atrVal > 0 ? atrVal : TickSize * 10;
        }
