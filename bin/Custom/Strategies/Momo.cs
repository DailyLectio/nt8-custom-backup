...
namespace NinjaTrader.NinjaScript.Strategies
{
    ...
    public class Momo : Strategy 
    {
        ...
        private bool IsBotAllowedByTrinity()
        {
            ...
            // Strip the contract month (e.g., "NQ 06-26" becomes "NQ") to match the HUD
            string baseSymbol = Instrument.MasterInstrument.Name;

            Indicators.RegimeMatrixHUD hudInstance = null;
            // Ask the global Parking Garage if a HUD exists for this base symbol
            ...
            // If we can't find a HUD for "NQ" or "ES", block trades for safety
            return false; 
        }
        ...
        private const string Stage1BotName = "OG_Momo";
